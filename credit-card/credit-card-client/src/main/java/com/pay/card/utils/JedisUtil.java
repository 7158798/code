...
public class JedisUtil {
    ...
    public static List<String> getString(List<String> keys) {
    ...
    public static void hsetnx(String hName, String key, String value) {
        ...
        redisTemplate.execute((RedisCallback<Boolean>) connection -> connection.hSetNX(key.getBytes(), key.getBytes(), value.getBytes()));
    ...
    public static void setSave(String setName, String value) {
        ...
        redisTemplate.execute((RedisCallback<Long>) connection -> connection.sAdd(setName.getBytes(), value.getBytes()));
    ...
    public void setRedisTemplate(RedisTemplate<String, String> redisTemplate) {
        if (JedisUtil.redisTemplate == null) {
