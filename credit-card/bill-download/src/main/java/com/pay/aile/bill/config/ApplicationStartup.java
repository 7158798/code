...
import com.pay.aile.bill.job.CopyRelationScheduler;
...
public class ApplicationStartup implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        if (event.getApplicationContext().getParent() == null) {
            ...
            CopyRelationScheduler copyRelationScheduler = event.getApplicationContext()
                    .getBean(CopyRelationScheduler.class);
            ...
            logger.info("do starup copyRelationLoop");
            executorService.execute(() -> {
                copyRelationScheduler.copyRelationLoop();
            });
        }
    }
