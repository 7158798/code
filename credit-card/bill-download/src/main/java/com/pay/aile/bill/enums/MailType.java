...
import com.pay.aile.bill.service.mail.download.impl.MailFoxmailOperationImpl;
...
import com.pay.aile.bill.service.mail.download.impl.MailSinaCnOperationImpl;
import com.pay.aile.bill.service.mail.download.impl.MailSinaOperationImpl;
import com.pay.aile.bill.service.mail.download.impl.MailVip163OperationImpl;
import com.pay.aile.bill.service.mail.download.impl.MailWoOperationImpl;
import com.pay.aile.bill.service.mail.download.impl.MailYeahOperationImpl;
...
public enum MailType {
    ...
    MAIL_139("139.com", Mail139OperationImpl.class),
    MAIL_163("163.com", Mail163OperationImpl.class),
    MAIL_ALIYUN("aliyun.com", MailAliyunOperationImpl.class),
    MAIL_HOT("outlook.com", MailHotOperationImpl.class),
    MAIL_QQ("qq.com", MailQQOperationImpl.class),
    MAIL_SINA("sina.com", MailSinaOperationImpl.class),
    MAIL_SINA_CN("sina.cn", MailSinaCnOperationImpl.class),
    MAIL_WO("wo.cn", MailWoOperationImpl.class),
    mail_189("189.cn", Mail189OperationImpl.class),
    MAIL_VIP163("vip.163.com", MailVip163OperationImpl.class),
    MAIL_FOXMAIL("foxmail.com", MailFoxmailOperationImpl.class),
    MAIL_YEAH("yeah.net", MailYeahOperationImpl.class);
