...
public enum CardTypeEnum {
    ...
    CCB_LK_NEW("CCB_LK_NEW", BankCodeEnum.CCB, "建行龙卡新版账单20171218"),
    ...
    CMB_DETAIL("CMB_DETAIL", BankCodeEnum.CMB, "招商银行消费明细账单"),
    CMB_PLATINA("CMB_PLATINA", BankCodeEnum.CMB, "招商银行白金卡账单"),
    CMB_DIAMON("CMB_DIAMON", BankCodeEnum.CMB, "招商银行砖石卡账单"),
