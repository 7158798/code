...
public class CreditBill extends Model<CreditBill> {
    ...
    public String toString() {
        return "CreditBill [accountType=" + accountType + ", bankCode=" + bankCode + ", beginDate=" + beginDate
                ...
                + ", billDay=" + billDay + ", emailId=" + emailId + ", endDate=" + endDate + ", id=" + id
                + ", lastAmount=" + lastAmount + ", minimum=" + minimum + ", month=" + month + ", repayment="
                + repayment + ", status=" + status + ", updateDate=" + updateDate + ", year=" + year + ", sentDate="
                + sentDate + ", fileId=" + fileId + ", cardNumbers=" + cardNumbers + ", cardDueDate=" + cardDueDate
                + ", cardBeginDate=" + cardBeginDate + ", cardEndDate=" + cardEndDate + ", foreignCurrency="
                + foreignCurrency + ", integral=" + integral + "]";
    }
